...
## Model Used
- Multinomial Naive Bayes: This algorithm works well for text classification problems because it is efficient with word frequency features.

## Feature Engineering
Text data is converted into numbers using:
- CountVectorizer: This technique creates a Bag of Words representation, which counts the frequency of each word in the dataset and converts it into a numerical matrix.

Example Prediction

Input: Bonjour je m'appelle Prachi
